#ifndef BPlus_Tree_Header_Buffer_Alt
#define BPlus_Tree_Header_Buffer_Alt
...
public:
     ...
     */
    bool readHeader(const std::string& filename, BPlusTreeHeaderAlt& bHeader);
    /**
     * @brief read header
